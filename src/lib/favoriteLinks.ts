...
export const FAVORITE_LINKS: FavoriteLink[] = [
  { label: '핀셋포인트', url: 'https://growth-mate.co.kr/reservations', emoji: '📌', bg: '#ece7fa', fg: '#5b46a8' },
  { label: '주차', url: 'https://npdc-i.nicepark.co.kr/', emoji: '🅿️', bg: '#e0eefa', fg: '#245d8f' },
  { label: '린다이어트', url: 'https://chart.leandiet.co.kr/patients?status=ongoing', emoji: '🥗', bg: '#dcf3f4', fg: '#0e7c86' },
