...
예약관리·한약 복용법 출력 등 기존 도구를 한 곳에서 접근하고, 앞으로 해피콜·비급여 관리·
물품신청 등을 하나씩 추가해 나가는 내부 운영 대시보드.
...
**초진환자 해피콜**과 **해피콜 목록**은 구현 완료(아래 참고). 나머지 기능(비급여, 비대면진료
신청, 물품신청 등)은 각각 별도로 설계해서 하나씩 채워 왔습니다.
